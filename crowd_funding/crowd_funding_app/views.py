...
def showProject(request, id):
    ...
    return render(request, "crowd_funding_app/viewProject.html", context)


def showCategoryProjects(request, id):
    category = Category.objects.get(id=id)
    context = {'catName': category}
    return render(request, "crowd_funding_app/viewCategory.html", context)
...
def create(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'crowd_funding_app/create.html', context)
    else:
...
def home(request):
    ...
    return render(request, 'crowd_funding_app/Home.html', context)
